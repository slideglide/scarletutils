...
cocos2d::ccColor3B layoutModeColorBackground =
    Mod::get()->getSavedValue<cocos2d::ccColor3B>("layoutModeColorBackground", {160,160,160});
...
bool autoReleaseGravityOrbs = false;
  ...
  ImGuiCocos::get()
      ...
      .draw([&] {
        ...
        style.Colors[ImGuiCol_Text] =
            ImVec4(0.8583691f, 0.8583605f, 0.8583605f, 1.0f);
        ...
        style.Colors[ImGuiCol_Border] =
            ImVec4(0.1882353f, 0.1882353f, 0.1882353f, 0.5f);
        ...
        style.Colors[ImGuiCol_CheckMark] =
            ImVec4(0.7424893f, 0.14658587f, 0.2540021f, 1.0f);
        ...
        style.Colors[ImGuiCol_NavWindowingDimBg] =
            ImVec4(1e-6f, 5.9227466e-7f, 5.9227466e-7f, 0.2f);
        style.Colors[ImGuiCol_ModalWindowDimBg] =
            ImVec4(1e-6f, 5.751073e-7f, 5.751073e-7f, 0.35f);
        ...
        if (ImGui::BeginTabBar("main")) {
          if (ImGui::BeginTabItem("Gameplay")) {
            ...
            // ImGui::Checkbox("Release Gravity Orbs", &autoReleaseGravityOrbs);
            ...
            if (ImGui::IsItemHovered()) {
              ImGui::BeginTooltip();
              ImGui::Text("Won't click black orbs if going up (or down "
            ...
            if (ImGui::IsItemHovered()) {
              ImGui::BeginTooltip();
              ImGui::Text("When you hit pink, yellow or red pads, "
                          "automatically swift click.");
              ImGui::EndTooltip();
            }
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("pe0", ImGuiDir_Right))
              ImGui::OpenPopup("maintain gravity options");

            if (ImGui::BeginPopup("maintain gravity options")) {
              ImGui::Checkbox("Player 1##maintain", &maintainGravityP1);
              ImGui::Checkbox("Player 2##maintain", &maintainGravityP2);
              ImGui::EndPopup();
            }
            ...
            if (ImGui::IsItemHovered()) {
              ...
              ImGui::Text("Known to drift under certain circumstances, please "
                          "don't report this as a bug.");
              ImGui::EndTooltip();
            }

            ImGui::SameLine();
            if (ImGui::ArrowButton("34z", ImGuiDir_Right))
              ImGui::OpenPopup("straight fly options");

            if (ImGui::BeginPopup("straight fly options")) {
              ImGui::Checkbox("Player 1##ship", &straightFlyP1);
              if (ImGui::IsItemEdited()) {
                Mod::get()->setSavedValue<bool>("straightFlyP1", straightFlyP1);
              }

              ImGui::PushItemWidth(100.f);
              ImGui::InputDouble("Threshold##p1ship", &straightFlyThresholdP1,
                                 0.0, 0.0, "%.2f");
              if (ImGui::IsItemEdited()) {
              ...
              if (ImGui::IsItemEdited()) {
                Mod::get()->setSavedValue<bool>("straightFlyP2", straightFlyP2);
              }

              ImGui::PushItemWidth(100.f);
              ImGui::InputDouble("Threshold##p2ship", &straightFlyThresholdP2,
                                 0.0, 0.0, "%.2f");
              if (ImGui::IsItemEdited()) {
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("920", ImGuiDir_Right))
              ImGui::OpenPopup("straight ufo options");

            if (ImGui::BeginPopup("straight ufo options")) {
              ImGui::Checkbox("Player 1##ufo", &straightUfoP1);
              if (ImGui::IsItemEdited()) {
                Mod::get()->setSavedValue<bool>("straightUfoP1", straightUfoP1);
              }

              ImGui::PushItemWidth(100.f);
              ImGui::InputDouble("Y Position Target##p1ufo",
                                 &straightUfoTargetP1, 0.0, 0.0, "%.5f");
              if (ImGui::IsItemEdited()) {
                straightUfoTargetP1 = std::max(straightUfoTargetP1, 0.0);
                Mod::get()->setSavedValue<double>("straightUfoTargetP1",
                                                  straightUfoTargetP1);
              }

              ImGui::InputDouble("Threshold##p1ufo", &straightUfoThresholdP1,
                                 0.0, 0.0, "%.5f");
              if (ImGui::IsItemEdited()) {
              ...
              if (ImGui::IsItemEdited()) {
                Mod::get()->setSavedValue<bool>("straightUfoP2", straightUfoP2);
              }

              ImGui::PushItemWidth(100.f);
              ImGui::InputDouble("Y Position Target##p2ufo",
                                 &straightUfoTargetP2, 0.0, 0.0, "%.5f");
              if (ImGui::IsItemEdited()) {
                straightUfoTargetP2 = std::max(straightUfoTargetP2, 0.0);
                Mod::get()->setSavedValue<double>("straightUfoTargetP2",
                                                  straightUfoTargetP2);
              }

              ImGui::InputDouble("Threshold##p2ufo", &straightUfoThresholdP2,
                                 0.0, 0.0, "%.5f");
              if (ImGui::IsItemEdited()) {
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("lep", ImGuiDir_Right))
              ImGui::OpenPopup("autoclicker p1 options");

            if (ImGui::BeginPopup("autoclicker p1 options")) {
              ImGui::PushItemWidth(100.f);
              ImGui::InputInt("Click every frames##p1", &autoclickerEveryP1, 0,
                              0);
              if (ImGui::IsItemEdited()) {
                autoclickerEveryP1 = std::max(autoclickerEveryP1, 0);
              }

              ImGui::InputInt("Hold for frames##p1", &autoclickerHoldP1, 0, 0);
              if (ImGui::IsItemEdited()) {
                autoclickerHoldP1 = std::max(autoclickerHoldP1, 1);
              }
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("wer", ImGuiDir_Right))
              ImGui::OpenPopup("autoclicker p2 options");

            if (ImGui::BeginPopup("autoclicker p2 options")) {
              ImGui::PushItemWidth(100.f);
              ImGui::InputInt("Click every frames##p2", &autoclickerEveryP2, 0,
                              0);
              if (ImGui::IsItemEdited()) {
                autoclickerEveryP2 = std::max(autoclickerEveryP2, 0);
              }

              ImGui::InputInt("Hold for frames##p2", &autoclickerHoldP2, 0, 0);
              if (ImGui::IsItemEdited()) {
                autoclickerHoldP2 = std::max(autoclickerHoldP2, 1);
              }
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("3t0", ImGuiDir_Right))
              ImGui::OpenPopup("noclip options");
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("88d", ImGuiDir_Right))
              ImGui::OpenPopup("extra click options");
          ...
          if (ImGui::BeginTabItem("Visual")) {
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("2qd", ImGuiDir_Right))
              ImGui::OpenPopup("level fade options");

            if (ImGui::BeginPopup("level fade options")) {
              ImGui::PushItemWidth(100.f);
              ImGui::InputDouble("Fade In##level", &fadeLevelInDuration, 0.0,
                                 0.0, "%.2f");
              if (ImGui::IsItemEdited()) {
                fadeLevelInDuration = std::max(fadeLevelInDuration, 0.0);
                Mod::get()->setSavedValue<double>("fadeLevelInDuration",
                                                  fadeLevelInDuration);
              }

              ImGui::InputDouble("Fade Out##level", &fadeLevelOutDuration, 0.0,
                                 0.0, "%.2f");
              if (ImGui::IsItemEdited()) {
            ...
            if (ImGui::IsItemEdited()) {
              Mod::get()->setSavedValue<bool>("fadeAudio", fadeAudio);
            }
            if (ImGui::IsItemHovered()) {
              ImGui::BeginTooltip();
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("324", ImGuiDir_Right))
              ImGui::OpenPopup("audio fade options");

            if (ImGui::BeginPopup("audio fade options")) {
              ImGui::PushItemWidth(100.f);
              ImGui::InputDouble("Fade In##audio", &fadeAudioInDuration, 0.0,
                                 0.0, "%.2f");
              if (ImGui::IsItemEdited()) {
                fadeAudioInDuration = std::max(fadeAudioInDuration, 0.0);
                Mod::get()->setSavedValue<double>("fadeAudioInDuration",
                                                  fadeAudioInDuration);
              }

              ImGui::InputDouble("Fade Out##audio", &fadeAudioOutDuration, 0.0,
                                 0.0, "%.2f");
              if (ImGui::IsItemEdited()) {
            ...
            if (ImGui::IsItemEdited()) {
              Mod::get()->setSavedValue<bool>("hideEndscreen", hideEndscreen);
            }
            if (ImGui::IsItemHovered()) {
              ImGui::BeginTooltip();
              ImGui::Text(
                  "Disables the statistics dropdown after completing a level.");
              ImGui::EndTooltip();
            }
            ...
            if (ImGui::IsItemEdited()) {
              Mod::get()->setSavedValue<bool>("noDeathEffect", noDeathEffect);
            }

            ImGui::Checkbox("No Effects", &noEffect);
            if (ImGui::IsItemEdited()) {
              Mod::get()->setSavedValue<bool>("noEffect", noEffect);
            }
            if (ImGui::IsItemHovered()) {
              ImGui::BeginTooltip();
            ...
            ImGui::SameLine();
            if (ImGui::ArrowButton("4jx", ImGuiDir_Right))
              ImGui::OpenPopup("layout mode options");

            if (ImGui::BeginPopup("layout mode options")) {
              static std::array<float, 3> bg =
                  colorToFloat(layoutModeColorBackground);
              ImGui::ColorEdit3("Background", bg.data());
              if (ImGui::IsItemEdited()) {
                layoutModeColorBackground = floatToColor(bg.data());
                Mod::get()->setSavedValue<ccColor3B>(
                    "layoutModeColorBackground", layoutModeColorBackground);
              }

              static std::array<float, 3> ground =
                  colorToFloat(layoutModeColorGround);
              ImGui::ColorEdit3("Ground", ground.data());
              if (ImGui::IsItemEdited()) {
                layoutModeColorGround = floatToColor(ground.data());
                Mod::get()->setSavedValue<ccColor3B>("layoutModeColorGround",
                                                     layoutModeColorGround);
              }
